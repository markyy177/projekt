...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 06. 20:16
...
--
ALTER TABLE `konyvek`
  ADD CONSTRAINT `konyvek_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `adatok` (`id`);
COMMIT;
